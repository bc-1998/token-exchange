...
export const subscribeToEvents = async (web3, token, account, exchange, dispatch) => {
...
export const loadBalances = async (dispatch, web3, exchange, token, account) => {
  ...
  const exchangeTokenBalance = await exchange.methods.balanceOf(token.options.address, account).call() //token is from props as token.contract which has options.address viewable from redux state token
